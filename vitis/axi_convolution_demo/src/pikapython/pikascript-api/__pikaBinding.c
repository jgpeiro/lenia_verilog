...
#include "PikaAxi.h"
#include "PikaAxi_Axi.h"
#include "PikaAxi.h"

#ifndef PIKA_MODULE_PIKAAXI_DISABLE
void PikaAxi_Axi_readMethod(PikaObj *self, Args *args){
    int addr = args_getInt(args, "addr");
    int res = PikaAxi_Axi_read(self, addr);
...
void PikaAxi_Axi_writeMethod(PikaObj *self, Args *args){
    int addr = args_getInt(args, "addr");
    int data = args_getInt(args, "data");
    PikaAxi_Axi_write(self, addr, data);
}
method_typedef(
    PikaAxi_Axi_write,
    "write", "addr,data"
...
class_def(PikaAxi_Axi){
    __BEFORE_MOETHOD_DEF
    method_def(PikaAxi_Axi_write, 279491920),
    method_def(PikaAxi_Axi_read, 2090683713),
};
class_inhert(PikaAxi_Axi, TinyObj);

PikaObj *New_PikaAxi_Axi(Args *args){
    PikaObj *self = New_TinyObj(args);
    obj_setClass(self, PikaAxi_Axi);
    return self;
}

Arg *PikaAxi_Axi(PikaObj *self){
    return obj_newObjInPackage(New_PikaAxi_Axi);
}
#endif
...
PikaObj *New_PikaMain(Args *args){
    ...
    obj_newObj(self, "PikaAxi", "PikaAxi", New_PikaAxi_Axi);
